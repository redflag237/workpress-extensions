...
RUN buildDeps=" \
    ...
    #&& docker-php-ext-install bcmath bz2 calendar iconv intl mbstring mcrypt mysql mysqli pdo_mysql pdo_pgsql pgsql  zip sockets
    && docker-php-ext-install pdo_mysql yaml soap xsl
